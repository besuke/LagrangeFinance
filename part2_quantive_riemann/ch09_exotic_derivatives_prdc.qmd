...
number_of_paths_prdc <- 300L
sensitivity_paths_prdc <- 100L
...
### II-9.1.3 Domestic、ForeignおよびDiscount Curve
...
show_plot_LFL(sample_fx_path_plot)
```

### II-9.3.3 金利為替系デリバティブの現在価値
...
## II-9.4 Couponの期間構造と分布

### II-9.4.1 期待Couponの期間構造
...
show_plot_LFL(expected_coupon_plot)
```
...
### II-9.4.2 Coupon キャップ／Floor到達確率
...
show_plot_LFL(volatility_sensitivity_plot)
```
...
part2_chapter_summary_tbl <- tibble::tribble(
  ...
  "II-5", "Credit risk and CDS", "Hazard rates and CDS valuation",
  "II-6", "Interest-rate model calibration", "SABR, Hull-White, and BGM calibration",
  "II-7", "Short-rate and forward-rate models", "Hull-White, HJM, BGM/LMM, and RFR FMM",
  "II-8", "Callable bonds and MBS prepayment", "Issuer call valuation and mortgage prepayment cash flows",
