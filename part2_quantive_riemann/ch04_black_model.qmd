...
subtitle: "Black-76、Black–Scholes–Mertonおよび数値評価法"
format:
  html:
    toc: true
...
## 1. Black–Scholes–MertonとBlack-76

### 1.1 Black–Scholes–Mertonモデル
...
cat(
  "\nChapter II-4 Black model completed successfully.\n"
)
```
