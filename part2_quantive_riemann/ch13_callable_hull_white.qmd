...
trade_date_calib <- QuantLibGauss::qlg_date("2022-08-19")
calendar_jp <- Japan()
...
QuantLibGauss::qlg_set_eval_date(trade_date_calib)
  ...
  function(i) {
    RateHelperVector_append(
      ...
      SwapRateHelper(
        ...
        QuantLibGauss::qlg_period(swap_rows$tenor[i]),
        calendar_jp,
        Frequency_Semiannual_get(),
        "ModifiedFollowing",
        dc_a365,
        JPYLibor(QuantLibGauss::qlg_period_months(6))
      )
    )
  }
)
...
trade_date <- QuantLibGauss::qlg_date("2024-04-15")
issue_date <- QuantLibGauss::qlg_date("2024-04-17")
maturity_date <- QuantLibGauss::qlg_date("2029-04-17")
...
flat_curve_obj <- safe_flat_curve(
  reference_date = QuantLibGauss::qlg_date("2024-04-17"),
  rate = market_yield,
...
swap_effective_date <- QuantLibGauss::qlg_date("2023-08-23")
swap_maturity_date <- QuantLibGauss::qlg_date("2028-08-23")
exercise_date <- calendar_jp$advance(trade_date_calib, 1L, "Years")
maturity_tenor <- QuantLibGauss::qlg_period_years(5L)
...
helper_detail_tbl_1 <- tibble(
  expiry_date = QuantLibGauss::qlg_iso(exercise_date),
  swap_effective_date = QuantLibGauss::qlg_iso(swap_effective_date),
  swap_maturity_date = QuantLibGauss::qlg_iso(swap_maturity_date),
...
multi_swap_input_tbl <- purrr::map_dfr(
  ...
  function(i) {
    ...
    tibble(
      ...
      expiry_date = QuantLibGauss::qlg_iso(expiry_date_i),
      swap_effective_date = QuantLibGauss::qlg_iso(swap_effective_i),
      swap_maturity_date = QuantLibGauss::qlg_iso(swap_maturity_i),
      annuity = annuity_i,
...
helper_list_multi <- purrr::map(
  ...
  function(i) {
    helper_i <- SwaptionHelper(
      ...
      QuantLibGauss::qlg_period_years(vol_data_multi$swap_tenor_year[i]),
...
swap_effective_hand <- QuantLibGauss::qlg_date("2023-08-23")
swap_maturity_hand <- QuantLibGauss::qlg_date("2028-08-23")
...
cf_year_tbl <- tibble(
  schedule_date = map_chr(fix_dates_hand, QuantLibGauss::qlg_iso),
