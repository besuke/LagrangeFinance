...
lfg_show_tbl(tona_bundle$quote_tbl, "TONA input quotes")
lfg_show_tbl(lfg_curve_tbl(tona_bundle$curve), "TONA curve table")
```
...
```{r i-spread-check}
curve_proxy_tbl <- lfg_curve_tbl(tona_bundle$curve, n = 500)
