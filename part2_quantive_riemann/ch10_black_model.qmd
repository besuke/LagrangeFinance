...
mc_terminal_tbl <- purrr::map_dfr(
  ...
  function(i) {
    ...
    tibble::tibble(
      path_id = i,
      terminal_price = QuantLibGauss::qlg_path_value_at(one_path, n_point - 1L)
    )
  }
) |>
  dplyr::mutate(
...
mc_path_tbl <- purrr::map_dfr(
  ...
  function(i) {
    ...
    QuantLibGauss::qlg_path_tbl(one_path, path_id = i)
  }
)
...
one_path_tbl <- QuantLibGauss::qlg_path_tbl(one_path_small, path_id = 1L)
