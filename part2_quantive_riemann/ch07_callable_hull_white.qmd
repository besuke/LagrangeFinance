---
title: "第II-7章 金利期間構造モデルと期限前償還債評価"
execute:
  eval: true
  echo: true
  warning: false
...
## II-7.1 ハル–ホワイトモデルと債券条件

### II-7.1.1 ハル–ホワイト 1-factorモデル
...
## II-7.4 Bermudan Receiver スワップションとの比較
...
## II-7.5 Vasicekモデルとハル–ホワイトモデル

### II-7.5.1 Vasicekモデルとの違い
...
### II-7.5.2 Vasicekとハル–ホワイトのゼロ金利曲線
...
### II-7.6.3 One-helper calibration
...
### II-7.6.4 ヨーロピアン スワップションのEngine比較
...
engine_comparison_tbl <- tibble::tribble(
  ...
  dplyr::mutate(
    difference_vs_bachelier = npv -
      npv_bachelier,
    difference_vs_jamshidian = npv -
      npv_jamshidian
  )
...
show_plot_LFL(tree_convergence_plot)
```
