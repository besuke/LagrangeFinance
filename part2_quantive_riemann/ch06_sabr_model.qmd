...
## II-6.1 SABRモデルとパラメータ

### II-6.1.1 SABRパラメータの役割
...
### II-6.1.4 Volatility of volatility
...
## II-6.5 Shifted SABR Normalのカリブレーション
...
GaussQuant::show_tbl_GQH(
  normal_smile_tbl |>
    dplyr::mutate(
      market_vol_bp = 10000 * market_vol,
      sabr_vol_bp = 10000 * sabr_vol,
      residual_bp = 10000 * residual
    ),
  "Shifted SABR normal smile table",
  n = 20
)
show_plot_LFL(normal_smile_plot)
```
...
### II-6.6.2 Black SABRとShifted SABR Normal
