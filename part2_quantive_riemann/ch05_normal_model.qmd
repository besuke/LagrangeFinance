---
title: "第II-5章 金利モデル（期間構造なし）ノーマルモデル"
execute:
  eval: true
  echo: true
  warning: false
...
## II-5.3 マイナス金利とボラティリティ分析

### II-5.3.1 ゼロ金利とマイナス金利
...
caplet_input_tbl <- tibble::tribble(
  ...
  dplyr::mutate(
    normal_volatility = normal_vol_bp / 10000,
    discount_factor = exp(
      -flat_discount_rate * payment_time
    ),
...
## II-5.6 ブラック・ボラティリティとノーマル・ボラティリティ
