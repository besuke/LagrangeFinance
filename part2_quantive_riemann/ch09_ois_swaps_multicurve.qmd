...
lfg_show_tbl(tona_quotes, "TONA market quotes", n = 20)
```
...
lfg_show_tbl(jpy_ois_fixed_cf_tbl, "TONA fixed leg cashflows", n = 10)
lfg_show_tbl(jpy_ois_float_cf_tbl, "TONA floating leg cashflows", n = 10)
```
...
lfg_show_tbl(jpy_daily_float_cf_tbl, "TONA daily forward leg", n = 20)
...
lfg_show_tbl(jpy_fixing_diag_tbl, "TONA daily fixing decomposition", n = 20)
```
...
lfg_show_tbl(curve_tbl(sofr_curve), "SOFR curve table", n = 12)
```
...
lfg_show_tbl(sofr_float_cf_tbl, "SOFR floating leg cashflows", n = 20)
...
lfg_show_tbl(curve_tbl(s_curve), "Single/forecast curve", n = 10)
```
...
lfg_show_tbl(curve_tbl(d_curve), "Discount curve", n = 10)
```
...
lfg_show_tbl(curve_tbl(f_curve), "Forward curve", n = 10)
```
