---
title: "第II-5章 信用リスクとクレジットデリバティブ"
execute:
  eval: true
  echo: true
  warning: false
...
## II-5.1 信用リスクとクレジットデリバティブの基礎

### II-5.1.1 デフォルト時刻と生存確率
...
### II-5.1.2 Recovery RateとLoss Given Default
...
### II-5.1.3 クレジットデリバティブ SpreadとHazard Rateの近似
...
## II-5.2 フラットカーブによるクレジットデリバティブ評価

### II-5.2.1 フラットカーブによる1年物クレジットデリバティブ
...
## II-5.3 Premium LegとProtection Leg

### II-5.3.1 Premium Legの手計算
...
```{r chapter05-protection-leg-hand}
...
### II-5.3.3 Risky PV01とFair Spread
...
## II-5.4 Hazard Rate推定と感応度

### II-5.4.1 Zero-NPV クレジットデリバティブからHazard Rateを推定する
...
```{r chapter05-hazard-calibration}
...
### II-5.4.2 SpreadとRecovery Rateの感応度
...
```{r chapter05-credit-sensitivity}
...
### II-5.5.2 標準CDSの支払スケジュール

CDS2015ルールにより、Premium支払日は標準化された四半期日へ調整される。

```{r chapter05-isda-schedule}
...
```{r chapter05-isda-discount-curve}
...
## II-5.6 ISDA Engineと評価比較

### II-5.6.1 ISDA クレジットデリバティブ Engine
...
```{r chapter05-isda-npv-decomposition}
...
### II-5.6.3 Fair SpreadとFair Upfront
...
```{r chapter05-fair-spread-upfront}
