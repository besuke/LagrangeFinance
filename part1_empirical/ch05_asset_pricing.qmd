...
```{r}
#| label: calculate-factor-risk-premia
#| eval: false
#| message: false
#| warning: false
...
### 5.2.4 FF3モデルによる株式資本コストの推定

```{r}
#| label: estimate-ff3-cost-of-capital
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: plot-cost-of-capital-distribution
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: plot-cost-of-capital-by-size
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: calculate-dividend-yield
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: estimate-implied-dividend-growth
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: estimate-factor-covariance
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: estimate-idiosyncratic-covariance
#| eval: false
#| message: false
#| warning: false
...
### 5.5.1 quadprogパッケージの準備

```{r}
#| label: install-quadprog
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: inspect-mean-variance-result
#| eval: false
#| message: false
#| warning: false
...
```{r}
#| label: extract-optimal-portfolio
#| eval: false
#| message: false
#| warning: false
...
本章では、Fama--Frenchの3ファクター・モデルを用いて、企業別のファクター・ローディングと株式資本コストを推定した。
