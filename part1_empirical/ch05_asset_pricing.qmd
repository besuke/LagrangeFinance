...
## 5.5 Fama-Frenchの3ファクター・モデルに基づいて株式資本コストを推定
...
## 5.16 solve.QP()関数を利用した平均分散ポートフォリオの計算 (1)
...
## 5.17 solve.QP()関数を利用した平均分散ポートフォリオの計算 (2)
...
## 5.18 solve.QP()関数を利用した平均分散ポートフォリオの計算 (3)
