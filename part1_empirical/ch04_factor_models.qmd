...
## 簿価時価比率に基づくポートフォリオ・ソート（時価総額加重の場合）
...
## 6 Size-BE/MEポートフォリオのリターンの可視化 (1)
...
## 6 Size-BE/MEポートフォリオのリターンの可視化 (2)
...
## 6 Size-BE/MEポートフォリオのリターンの可視化 (3)
