...
tibble(
  ...
  path = base::c(
    ".",
    relative_path_LFL(raw_event_data_dir),
    relative_path_LFL(derived_event_data_dir)
  )
)
```
...
tibble(
  ...
  path = relative_path_LFL(base::unname(vec_input_path))
)
```
...
tibble(
  ...
  path = relative_path_LFL(base::unname(vec_output_path))
)
```
