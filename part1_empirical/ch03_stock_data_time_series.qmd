...
## left_join()関数，及びright_join()関数による欠損値の処理
...
## firm_IDが1の企業の月次超過リターンを折れ線グラフで可視化
...
## firm_IDが1の企業の月次超過リターンをヒストグラムで可視化
...
## broomパッケージのtidy()関数で係数の推定値に関する結果を確認
...
## broomパッケージのglance()関数でモデル全体の当てはまりを確認
